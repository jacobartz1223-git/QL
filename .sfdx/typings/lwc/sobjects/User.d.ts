...
declare module "@salesforce/schema/User.Bypass_Validation__c" {
  const Bypass_Validation__c:boolean;
  export default Bypass_Validation__c;
}
declare module "@salesforce/schema/User.Common_ID__c" {
  const Common_ID__c:string;
  export default Common_ID__c;
}
declare module "@salesforce/schema/User.QLS_String__c" {
  const QLS_String__c:string;
  export default QLS_String__c;
}
declare module "@salesforce/schema/User.Region__c" {
  const Region__c:string;
  export default Region__c;
}
declare module "@salesforce/schema/User.Signature__c" {
  const Signature__c:string;
  export default Signature__c;
}
declare module "@salesforce/schema/User.Sales_Role__c" {
  const Sales_Role__c:string;
  export default Sales_Role__c;
}
declare module "@salesforce/schema/User.Is_Regional_Director__c" {
  const Is_Regional_Director__c:boolean;
  export default Is_Regional_Director__c;
}
declare module "@salesforce/schema/User.Leader_Role__c" {
  const Leader_Role__c:string;
  export default Leader_Role__c;
}
declare module "@salesforce/schema/User.Out_of_Office__c" {
  const Out_of_Office__c:boolean;
  export default Out_of_Office__c;
}
declare module "@salesforce/schema/User.RocketPro_Contacts_Owned__c" {
  const RocketPro_Contacts_Owned__c:number;
  export default RocketPro_Contacts_Owned__c;
}
